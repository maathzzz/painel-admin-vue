...
<template>
    <form class="w-full h-auto flex flex-col gap-5">
        <h2 class="text-2xl font-bold"> Editar {{ product?.name }}</h2>
        <div class="flex flex-col gap-5">
            <div class="flex flex-col gap-3 lg:gap-0 lg:flex-row items-center justify-between">
                <div>
                    <label for="Name" class="block text-sm font-medium text-gray-700"> Editar Nome </label>
                    <input
                        v-model="name"
                        type="text"
                        id="Name"
                ...
                <div>
                    <label for="Price" class="block text-sm font-medium text-gray-700"> Editar Preço </label>
                    <input
                        v-model="price"
                        type="number"
                        id="Price"
                ...
                <div>
                    <label for="CategoryId" class="block text-sm font-medium text-gray-700"> Editar Categoria </label>
                    <input
                        v-model="category_id"
                        type="Number"
                        id="CategoryId"
            ...
            <div class="">
                <label for="Description" class="block text-sm font-medium text-gray-700"> Editar Descrição </label>
                <textarea
                    v-model="description"
                    id="Description"
